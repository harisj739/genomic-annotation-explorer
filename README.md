...
- **Genneth AI assistant** — Ask questions about your loaded file in natural language
- **Educational mode** — In-app explanations of genomic file formats

## Genneth — AI Genomic Assistant

After loading a file, click **"Ask Genneth"** in the header to open the AI chat panel. Genneth is an AI assistant that can answer questions about the currently loaded file — feature counts, chromosome distribution, strand information, and more.

Genneth only discusses the loaded file and will politely decline off-topic questions.

### Getting an API Key

Genneth is powered by [Claude](https://claude.ai) (Anthropic). Each user needs their own free API key:
...
4. In the app, click **🔑 Add key** inside the Genneth panel and paste your key
5. Your key is saved in your browser's local storage — it is never sent anywhere except directly to Anthropic's API

> **Note:** Anthropic offers free credits for new accounts. Each question to Genneth costs a fraction of a cent using the Claude Haiku model.
